...
base_dir = r"/project/glennie/fhacesga/RECTDNN/FLNN/general/AAA_NewDataset_2/"
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if epoch % 10 == 0:
            torch.save({
                ...
                'lr_list' : lr_list
            }, r'/project/glennie/fhacesga/RECTDNN/FLNN/checkpoint_112424_nontiled.pth')
            
            torch.save(model, r"/project/glennie/fhacesga/RECTDNN/FLNN/112424_nontiled.pth")
...
model = train(model, loaders, num_epochs=5000, learning_rate=1e-4, 
              continue_from= r'/project/glennie/fhacesga/RECTDNN/FLNN/checkpoint_112024_nontiled_1.pth'
             )
